...
silent only
cd ~/.dot/common/.config/ranger
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +179 ~/.dot/common/.config/ranger/rc.conf
argglobal
silent! argdel *
edit ~/.dot/common/.config/ranger/rc.conf
...
silent! normal! zE
let s:l = 81 - ((58 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
normal! 024|
lcd ~/.dot/common/.config/ranger
tabnext 1
if exists('s:wipebuf')
