...
## blacklisted host should be `ads.example.org`. If you want to disable
...
## Type: Font
c.fonts.completion.category = 'bold 13pt Terminus'

## Font used in the completion widget.
## Type: Font
c.fonts.completion.entry = '13pt Terminus'

## Font used for the debugging console.
## Type: QtFont
c.fonts.debug_console = '13pt Terminus'

## Font used for the downloadbar.
## Type: Font
c.fonts.downloads = '13pt Terminus'
...
## Type: Font
c.fonts.keyhint = '13pt Terminus'

## Font used for error messages.
## Type: Font
c.fonts.messages.error = '13pt Terminus'

## Font used for info messages.
## Type: Font
c.fonts.messages.info = '13pt Terminus'

## Font used for warning messages.
## Type: Font
c.fonts.messages.warning = '13pt Terminus'
...
## supported, so `;*` will whitelist all keychains starting with `;`. Use
## `*` to disable keyhints.
## Type: List of String
# c.keyhint.whitelist = []
...
c.url.searchengines = {
    ...
    #"DEFAULT" : "https://duckduckgo.com/{}",
     ...
     "DEFAULT" : "https://search.rhscz.eu/?q={}&categories=general&language=en-US",
     ...
     "f"       : "https://search.rhscz.eu/?q={}&category_files=on",
     ...
     "gr"      : "https://github.com/search?l=&q={}+language%3ARust&type=code",
    ...
    #"gt"      : "https://translate.google.com/#auto|en|{}",
     "gt"      : "https://www.deepl.com/translator#auto/en/{}",
    ...
    #"i"       : "https://duckduckgo.com/{}?ia=images",
     "i"       : "https://search.rhscz.eu/?q={}&category_images=on",
    "it"       : "https://search.rhscz.eu/?q={}&category_it=on",
    ...
    #"m"       : "https://maps.google.com/maps?q={}",
     ...
     "mu"      : "https://search.rhscz.eu/?q={}&category_music=on",
     ...
     "ne"      : "https://search.rhscz.eu/?q={}&category_news=on",
     "np"      : "https://search.nix.gsc.io/?q={}",
     "o"       : "https://www.openstreetmap.org/search?query={}",
     "r"       : "https://reddit.com/search?q={}",
     "rc"      : "https://crates.io/search?page=1&per_page=10&q={}",
     "re"      : "https://repology.org/project/{}/versions",
