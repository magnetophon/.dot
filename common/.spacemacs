...
there are no attachments."
  ...
  (setq org-todo-keywords '(
                            (sequence "TODO(t!)" "NEXT(n!)" "WAIT(w@/!)" "OTHERS(o!)" "|" "DONE(d)" "CANCELLED(c)")
                            ))
