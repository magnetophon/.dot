...
alias fzg="sk -i -c 'rg --smart-case --color always --line-number '{}'' --preview '~/.local/bin/fzg_preview.sh {0}' --ansi --reverse --bind 'alt-z:toggle-preview,alt-a:toggle-all,ctrl-a:select-all' --multi --exact --no-height --color=light"
